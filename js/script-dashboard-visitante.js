...
document.addEventListener('DOMContentLoaded', function() {
    ...
    configurarEventos();
    // Restaurar sesión desde localStorage si sessionStorage está vacío (Vercel routing)
    if (!sessionStorage.getItem('tipoUsuario') && localStorage.getItem('tipoUsuarioActual') === 'visitante') {
        sessionStorage.setItem('tipoUsuario', 'visitante');
        sessionStorage.setItem('rolUsuario', 'visitante');
        var nvLocal = localStorage.getItem('nombreVisitanteActual') || '';
        var evLocal = localStorage.getItem('emailVisitanteActual') || '';
        if (nvLocal) sessionStorage.setItem('nombreVisitante', nvLocal);
        if (evLocal) sessionStorage.setItem('emailVisitante', evLocal);
    }
    ...
    if (btnLogoutVisitante) {
        btnLogoutVisitante.addEventListener('click', function() {
            ...
            localStorage.removeItem('nombreVisitanteActual');
            localStorage.removeItem('emailVisitanteActual');
